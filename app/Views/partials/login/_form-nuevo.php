<form action="<?= base_url() ?>/login/registrarse" method="post">
    ...
    <fieldset>
        ...
        <input id="usuario" type="text" name="usuario" placeholder="Nombre de usuario" value="<?= old('usuario') ?>">
        <label for="correo">Correo:<abbr title="requerido" aria-label="required">*</abbr></label>
        <input id="correo" type="email" name="correo" placeholder="correo@algo.com" value="<?= old('correo') ?>">
        <label for="password">Contraseña:<abbr title="requerido" aria-label="required">*</abbr></label>
        <input id="password" type="password" name="password" placeholder="Entre 3 y 14 caracteres" value="<?= old('password') ?>">
        <label for="pass_confirm">Repetir contraseña:<abbr title="requerido" aria-label="required">*</abbr></label>
        <input id="pass_confirm" type="password" name="pass_confirm" placeholder="Entre 3 y 14 caracteres" value="<?= old('pass_confirm') ?>">
    </fieldset>
